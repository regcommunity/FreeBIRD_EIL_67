...
class Derivatives_ETC(F_14_00_REF_FINREP_3_0_Base):
	...
	@lineage(dependencies={"EXCHNG_TRDBL_DRVTV_PSTN_RL.ACCMLTD_CHNGS_FV"})
	def ACCMLTD_CHNGS_FV(self):
		return self.EXCHNG_TRDBL_DRVTV_PSTN_RL.ACCMLTD_CHNGS_FV
...
class Debt_securities(F_14_00_REF_FINREP_3_0_Base):
	...
	@lineage(dependencies={"LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT.ACCMLTD_CHNGS_FV"})
	def ACCMLTD_CHNGS_FV(self):
		return self.LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT.ACCMLTD_CHNGS_FV
	...
	@lineage(dependencies={"LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT.FV_CHNG"})
	def FV_CHNG(self):
		return self.LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT.FV_CHNG
	SCRTY_EXCHNG_TRDBL_DRVTV = None # SCRTY_EXCHNG_TRDBL_DRVTV
	@lineage(dependencies={"SCRTY_EXCHNG_TRDBL_DRVTV.NGTBL_SCRTY_INDCTR"})
	def NGTBL_SCRTY_INDCTR(self):
		return self.SCRTY_EXCHNG_TRDBL_DRVTV.NGTBL_SCRTY_INDCTR
