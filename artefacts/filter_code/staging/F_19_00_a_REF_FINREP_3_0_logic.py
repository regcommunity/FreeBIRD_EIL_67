...
class Debt_securities(F_19_00_a_REF_FINREP_3_0_Base):
	...
	@lineage(dependencies={"LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT.NN_PRFRMNG_PRR_FRBRNC_INDCTR"})
	def NN_PRFRMNG_PRR_FRBRNC_INDCTR(self):
		return self.LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT.NN_PRFRMNG_PRR_FRBRNC_INDCTR
	PRTY = None # PRTY
	@lineage(dependencies={"PRTY.INSTTTNL_SCTR"})
	def INSTTTNL_SCTR(self):
		return self.PRTY.INSTTTNL_SCTR
